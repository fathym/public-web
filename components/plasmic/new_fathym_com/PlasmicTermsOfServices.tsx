  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicTermsOfServices.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicTermsOfServices.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicTermsOfServices.pageMetadata.description}
        />
        <meta
          key="og:description"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicTermsOfServices.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
